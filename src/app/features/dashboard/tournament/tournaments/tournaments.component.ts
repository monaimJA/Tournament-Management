...
export class TournamentsComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['label','startDate','endDate', 'actions'];
  @ViewChild('createTournamentModal') createTournamentModal: any;
  @ViewChild(MatPaginator) paginator: MatPaginator;
  showFirstLastButton: boolean = true;

  constructor(private dialog: MatDialog, private router: Router, private fb: FormBuilder, private tournamentService: TournamentService, private route: ActivatedRoute) {
